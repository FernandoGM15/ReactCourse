...
const ProductsResume = ({ order }: { order: AddOrder[] }) => {
      ...
      {order.map((product) => (
        ...
        >
          ...
          <div>
            <button
              type="button"
              className="gap-2 bg-sky-700 flex px-5 py-2 text-white rounded-md font-bold uppercase shadow-md w-full my-2"
            ...
            <button
              type="button"
              className="gap-2 bg-red-700 flex px-5 py-2 text-white rounded-md font-bold uppercase shadow-md w-full my-2"
